---
title: "COVID-19 New Confirmed Cases in PERU"
author: "Javier Chang"
date: "17/5/2020"
...
**`r diastrans`** days have passed since the first case appeared and yesterday we had **`r format(yesterdaycases, big.mark=",")`** new confirmed cases. It is above the **`r percentilrank`th** percentile of new confirmed daily cases and it is above the **`r percentilwod`th** percentile of the corresponding day of the week.
...
##countries <- unique(covid$iso_code)
...
## Model fitting with a **normal curve** for PERU
